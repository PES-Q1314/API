...
XS_SHARING_ALLOWED_ORIGINS = ['http://localhost:8000', 'http://ks3370775.kimsufi.com', 'http://localhost']
XS_SHARING_ALLOWED_METHODS = ['POST', 'GET', 'OPTIONS', 'PUT', 'PATCH', 'DELETE']
XS_SHARING_ALLOWED_HEADERS = ['Origin', 'Content-Type', 'Accept', 'X-CSRFToken', 'withCredentials', 'x-requested-with']
