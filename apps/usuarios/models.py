...
class Estudiante(PerfilSuscriptor, Perfil):
    ...
    disponibilidad = models.CharField(choices=enums.DISPONIBILIDAD, max_length=50, blank=True, null=True)

    # Metadatos del estudiante
    nivel_de_privacidad = models.CharField(choices=enums.NIVEL_DE_PRIVACIDAD, default='privado', max_length=50)
...
class Empresa(Perfil):
    ...
    tamanyo = models.CharField(choices=enums.TAMANYO_DE_EMPRESA, max_length=50, blank=True, null=True)
    descripcion = models.TextField(blank=True, null=True)
